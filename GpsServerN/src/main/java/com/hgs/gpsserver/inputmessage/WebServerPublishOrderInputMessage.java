...
public class WebServerPublishOrderInputMessage extends CommandMessage {
	...
	public WebServerPublishOrderInputMessage(byte[] buff) {
	...
	public OutputMessage getOutputMessageToDevice() {
		if(invalideMsg) {
			logger.debug("This message from webServer is wrong <{}>", str);
			return null;
		}
		OutputMessage message = OutputMessageFactory.instance.createOutputMessage(OutputMessageType.PublishOrder, this.msg);
